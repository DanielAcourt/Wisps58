...
async def unreal_chat(request: UnrealChatRequest):
    ...
    tools = [
        ...
        {"type": "function", "function": {"name": "send_unreal_directive", "description": "Sends a physical runtime action directive (e.g., EjectAgentPossession, PerformAgentPossession, Interact, MoveToLocation) directly to a target Unreal Engine entity during play. For PerformAgentPossession, supply parameters: {\"target_vessel\": \"<EntityID_or_ActorName>\"}.", "parameters": {"type": "object", "properties": {"target_entity": {"type": "string", "description": "The target entity or agent name (e.g., SIM_IronKnight or MySovereignBaseInteractable)"}, "action_name": {"type": "string", "description": "The directive action name (e.g. EjectAgentPossession, PerformAgentPossession, Interact)"}, "parameters": {"type": "object", "description": "Action parameters object. For PerformAgentPossession, set target_vessel to target entity ID, GUID, or actor name."}}, "required": ["target_entity", "action_name"]}}}
    ]
