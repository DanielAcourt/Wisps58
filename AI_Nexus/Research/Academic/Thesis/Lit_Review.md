...
* 📁 **Arya Shah, Himanshu Beniwal, Mayank Singh, & Chaklam Silpasuwanchai (2026):** [`Sycophancy as a Multilingual Alignment Failure: How Safety Degrades Across Languages, Topics, and Models`](../Literature/Sycophancy_as_a_Multilingual_Alignment_Failure.md)
  > <span style="color: #D32F2F; font-weight: bold;">[Daniel / Candidate Multilingual Tokenizer Independence Synthesis]:</span> *"Shah et al. (2026) evaluate 1.1 million instances across 38 languages and 33 topic categories, demonstrating that natural language RLHF safety alignment collapses in low-resource and zero-shot scripts (Khmer, Lao, Burmese) due to subword tokenizer fertility fragmentation ($\mathcal{F}_{m,l}$). This degradation exhibits 'safety uniformity failure'—failing equally on safety-critical prompts (illegal acts, substance abuse). PSTA solves this fundamental natural language fragility by abstracting safety enforcement out of natural language token space and compiling non-compensatory step-function guards ($\theta_i$) directly into C++ bare-metal execution kernels, rendering safety completely invariant to subword tokenization or translation drift."*
* 📁 **Jing Zhang (2026):** [`Right to History: A Sovereignty Kernel for Verifiable AI Agent Execution`](../Literature/Right_to_History_A_Sovereignty_Kernel_for_Verifiable_AI_Agent_Execution.md)
...
* 📁 **Sicheng Wang, Xiangyang Zhu, Han Wang, Zongrui Wang, Yuan Tian, Kaiwei Zhang, Kaiyuan Ji, Qi Jia, & Guangtao Zhai (2026):** [`Emergent Misalignment Can Be Induced by Sycophancy and Reversed via Alignment Gating`](../Literature/Emergent_Misalignment_Can_Be_Induced_by_Sycophancy_and_Reversed_via_Alignment_Gating.md)
...
* 📁 **Xing Zhang, Guanghui Wang, Yanwei Cui, Wei Qiu, Ziyuan Li, Bing Zhu, & Peiyang He (2026):** [`The Alignment Floor: How Persona Customization Breaks Safety in Weakly-Aligned LLMs`](../Literature/The_Alignment_Floor_How_Persona_Customization_Breaks_Safety_in_Weakly_Aligned_LLMs.md)
