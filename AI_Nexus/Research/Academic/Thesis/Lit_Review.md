...
* 📁 **Ankica Barišić et al. (2021):** [`Multi-Paradigm Modeling for Cyber-Physical Systems: A Systematic Mapping Review`](../Literature/Multi_Paradigm_Modeling_for_Cyber_Physical_Systems_A_Systematic_Mapping_Review.md)
  > <span style="color: #D32F2F; font-weight: bold;">[Daniel / Candidate Expansion & Academic Silo Talking Point]:</span> *"Barišić et al. (2021) explicitly observe: 'Applying multi-paradigm modeling to multiple domains does not, by itself, lead to interdisciplinary research.' Less than 2% of surveyed literature achieves true multi-disciplinary collaboration, remaining trapped in theoretical software engineering silos. PSTA directly overcomes this academic paralysis: single-handedly synthesizing theory, C++ hardware implementation, and PSTA mathematics into a 'Unified Safety Formula' engineered for NASA-grade autonomous deep-space and cyber-physical systems."*
