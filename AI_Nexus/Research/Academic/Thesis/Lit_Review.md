...
* 📁 **Seth Dobrin & Łukasz Chmiel / ARYA Labs (2026):** [`The Unfireable Safety Kernel: Execution-Time AI Alignment for AI Agents and Other Escapable AI Systems`](../Literature/The_Unfireable_Safety_Kernel_Execution_Time_AI_Alignment_for_AI_Agents.md)
  > <span style="color: #D32F2F; font-weight: bold;">[Daniel / Candidate Critique, Technical Refutation & Recursive Safety Warning]:</span> *"Dobrin & Chmiel (2026) concede a terrifying vulnerability: 'The kernel does not yet provide a formal policy layer governing which self-modifications are permitted, as distinct from authorizing the act of self-modification at all.' Autonomous recursive self-improvement without human-in-the-loop (HITL) authority is profoundly dangerous—it is the root cause of agent escape, as any autonomous self-modification loop will eventually overwrite or bypass its own guardrails. This is precisely why I halted the Commander SOP and enforced the Agency Arbitration Schema (AAS) 409 CONFLICT GATE. True execution-time alignment requires bare-metal C++ memory isolation ($\theta_i$) and mandatory human authority handshakes."*
