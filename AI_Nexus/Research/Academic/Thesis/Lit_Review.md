...
* 📁 **Ankica Barišić et al. (2021):** [`Multi-Paradigm Modeling for Cyber-Physical Systems: A Systematic Mapping Review`](../Literature/Multi_Paradigm_Modeling_for_Cyber_Physical_Systems_A_Systematic_Mapping_Review.md)
  > <span style="color: #D32F2F; font-weight: bold;">[Daniel / Candidate Expansion Synthesis]:</span> *"Barišić et al. (2021) survey a decade of CPS modeling research across 153 studies, revealing that multi-paradigm modeling is crippled by tool fragmentation (UML, SysML, Simulink) and fragile batch transformations, with only 8.5% supporting true model integration. PSTA expands on MPM4CPS by replacing lossy multi-tool patchworks with a single, unified 9-Tier Universal Stack and a non-compensatory 4-pillar PSTA Safety Kernel ($P, S, T, A$), enforcing real-time deterministic integration across physical, digital, social, and administrative domains."*
