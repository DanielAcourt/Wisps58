...
| AD-024 | Community: Fab Marketplace Plugin & Utility Widget Packaging | 5 | In Progress | DevOps | Wrap the Python asset sync engine into an Unreal Engine Editor Utility Widget (EUW) toolbar button and list it on Fab. | Packaged Fab-ready plugin with in-editor UI panel and 1-click toolbar sync button. |
