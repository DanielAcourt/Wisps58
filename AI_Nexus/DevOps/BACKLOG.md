...
| AD-005a | Spatial Sense: Save State Ingestion | 5 | Completed | Research/DevOps | Ingest the serialized component save packet during `/v1/unreal/chat` calls. | Map serialized JSON save payloads to the LLM's system context prompt framing. |
